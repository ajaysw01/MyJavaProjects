...
<body>
	...
	<script type="text/javascript">
		...
		if(status == "invalidEmail" ){
    		swal.fire("Sorry", "Please Enter a Valid Email","error")
    	}
		else if(status == "invalidName" ){
    		swal.fire("Sorry", "Please Enter a Valid name","error")
    	}
		else if(status == "invalidPass" ){
    		swal.fire("Sorry", "Please Enter a Valid Password","error")
    	}
		else if(status == "invalidConfirmPass" ){
    		swal.fire("Sorry", "Password Mismatch","error")
    	}
		else if(status == "invalidContact" ){
    		swal.fire("Sorry", "Please Enter a Valid Contact","error")
    	}
